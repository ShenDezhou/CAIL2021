...
support_dataset = ['RecTextLineDataset',"RecAsWholeTextLineDataset", 'RecLmdbDataset', 'DetTextLineDataset','JsonDataset']
support_loader = ['RecDataLoader', 'DataLoader','ImageFolder']
...
def build_loader(dataset, config):
    ...
    dataloader_class = dataset
    if collate_fn:
        dataset.set_attrs(transform=collate_fn)
