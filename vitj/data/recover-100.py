...
data_pack = joblib.load("train_100.data")
...
_ = [os.makedirs("cifar100_test/"+str(label), exist_ok=True) for label in set(labels)]
for i in range(len(data_pack['data'])):
    ...
    pixels.save(f"cifar100_test/{labels[i]}/" + filename, format)
    #print(labels[i])
print('FIN')